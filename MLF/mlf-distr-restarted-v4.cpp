...
void processArgs(int argc, char* argv[], int * krylovDegree, string * mtxName, int * l) {
...
int main (int argc, char* argv[]) {
    ...
    processArgs(argc, argv, &krylovDegree, &mtxPath, &l);
    ...
    b =  restartedArnoldiIteration_MLF(A, b, krylovDegree, size, me, &V, &H, alpha, beta, betaNormB, l);
    exec_time_arnoldi += omp_get_wtime();
    if(me == 0) {
